...
public interface AnalyzeRunner
{
     ...
     * @param configPath the language server checks configuration file to pass to the launcher, or
     *     {@code null} to run with the launcher's own defaults
     ...
     */
    Path analyze(Path serverExecutable, Path srcDir, Path outputDir, Path configPath, IProgressMonitor monitor)
