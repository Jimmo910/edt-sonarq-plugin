...
public final class Messages extends NLS
{
    ...
    public static String BslChecksPage_EnableAll;
    public static String BslChecksPage_EvidenceTooltip;
    public static String BslChecksPage_FetchCatalog;
    public static String BslChecksPage_FetchFailed;
    ...
    public static String PreferencePage_LocalGroup;
    public static String PreferencePage_MarkersGroup;
    public static String PreferencePage_Mode;
    public static String PreferencePage_Mode_CiTrigger;
    public static String PreferencePage_Mode_Local;
    public static String PreferencePage_Mode_LocalAuto;
    public static String PreferencePage_Mode_LocalPath;
    public static String PreferencePage_Mode_Server;
    ...
    public static String SonarPrefs_BslEngine_InstalledVersion;
