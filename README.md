...
- **Строка статуса** внизу показывает число замечаний, ветку и время последнего обновления, а
  также — сколько из загруженных замечаний **не показаны в окне Problems** (когда файл
  замечания не сопоставляется ни с одним файлом воркспейса); это часть ценности окна замечаний
  поверх стандартного Problems, где такие замечания не видны вовсе.
